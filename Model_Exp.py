# -*- coding: utf-8 -*-
"""
Created on Thu May  4 11:13:50 2023
...
class Param():
    ...
    def __init__(self, rv_in, V_s, m_dot_n, N_n, AU_su_n, A_leak, AU_ex_n, W_dot_loss_n, alpha_loss, AU_amb, T_amb):
        self.rv_in = rv_in
        self.V_s = V_s
        self.m_dot_n = m_dot_n
        self.N_n = N_n
        self.AU_su_n = AU_su_n
        self.A_leak = A_leak
        self.AU_ex_n = AU_ex_n
        self.W_dot_loss_n = W_dot_loss_n
...
class Expander():
    ...
    def System(self, x):
        ...
        m_dot_leak_bis = (self.params.A_leak/v_thr_leak)*C_neck_leak
        ...
        W_dot_loss = self.params.W_dot_loss_n*((N/self.params.N_n)**2) + self.params.alpha_loss * W_dot_in
        ...
        Q_dot_amb = self.params.AU_amb*(self.T_w-self.params.T_amb)
